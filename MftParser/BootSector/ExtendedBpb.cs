...
/// </summary>
/// <param name="TotalSectors">Total size of the volume in sectors</param>
...
/// <param name="MftRecordSize">Number of clusters used per single MFT record. If this value is greater than 0, then it represents number of clusters.
...
/// <param name="IndexRecordSize">Number of cluster used per single INDX record. If this value is greater than 0, then it represents number of clusters.
/// If it's negative, then use it's absolute value as a power of two to get record size in bytes.
...
public readonly record struct ExtendedBpb(long TotalSectors, long MftCluster, long MftMirrCluster, 
    sbyte MftRecordSize, sbyte IndexRecordSize, long VolumeSerialNumber)
{
